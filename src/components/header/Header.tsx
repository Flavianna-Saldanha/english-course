    ...
    <div className="">
      <section className="mt-24 flex flex-col text-center gap-10 md:flex-row md:justify-center md:items-center md:mx-8 lg:gap-20">
        <div className="flex flex-col gap-6 md:text-start">
          <h1 className="uppercase text-3xl w-80 m-auto md:m-0 lg:text-4xl">
            Aprenda inglês agora mesmo!
          </h1>
          <p className="text-justify w-72 text-sm m-auto font-sans md:m-0 lg:w-96 lg:text-lg">
        ...
        <div className="flex justify-center ">
          <Image
            ...
            className="object-contain drop-shadow-[0_30px_40px_rgba(0,0,0,0.25)] lg:w-[600px]"
          />
        </div>
      </section>
    </div>
