...
export const PitchSection = () => {
    return(
        <div>
            <div className="mt-30 flex flex-col items-center gap-20 md:gap-32 md:flex-row border border-red-500 md:justify-center">
                <div className="flex flex-col gap-4 items-center md:items-start">
                    <h2 className="font-arial text-4xl md:text-5xl font-black leading-7 tracking-tighter">
                ...
                <div className="relative w-fit">
                    ...
                    <Image
                        ...
                        width={200}
                        height={300}
                        className="relative z-10 md:w-80"
                    />
                </div>
            </div>
        </div>
